...
pub use suite::{
    acquire_suite_slot, is_filtered_run, is_nextest_run, nextest_outer_lock_required, suite_slot,
    SUITE_SLOT,
};
...
pub fn await_singleton_released(state: &Path) {
...
pub const MOCK_PY: &str = include_str!("../fixtures/providers/codex.py");
...
pub const MOCK_WS_PY: &str = include_str!("../fixtures/providers/codex-websocket.py");
...
pub const MOCK_TMUX_PY: &str = include_str!("../fixtures/providers/tmux.py");
...
pub const MOCK_DEVIN_PY: &str = include_str!("../fixtures/providers/devin.py");
...
pub fn install_mock_tmux(dir: &Path) {
...
pub const MOCK_STUB_PY: &str = include_str!("../fixtures/providers/stub.py");
...
/// `$FAKE_PANE` (set by the mock tmux) points at the session state.
pub const MOCK_CLAUDE_TUI_PY: &str = include_str!("../fixtures/providers/claude-tui.py");
...
/// `$FAKE_PANE` (set by the mock tmux) points at the session state.
pub const MOCK_CURSOR_TUI_PY: &str = include_str!("../fixtures/providers/cursor-tui.py");
...
pub fn mock_knob(dir: &Path, name: &str, value: Option<&str>) {
...
pub const MOCK_CLAUDE_PY: &str = include_str!("../fixtures/providers/claude-managed.py");
...
/// and the optional purpose line the board shows (CAD-563).
