...
| `plan_approve`, `plan_reject`, `approval_record`, `approval_revoke`, `model_defaults_set`, `slot_reconcile`, `project_new` | the proven operator (`operator_connection`; `project_new` also the master once CAD-339 lands) | every agent |
