...
| How is identity and role policy designed? | [Role-profiles ADR](adr/0001-role-profiles.md), [operator-identity ADR (proposed)](adr/0004-operator-identity-web-ui.md), [audit](AUDIT.md), [risk rules](roles/risk-classes.md). An ADR is not proof every phase shipped. |
