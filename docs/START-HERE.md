...
| How is identity and role policy designed? | [Role-profiles ADR](adr/0001-role-profiles.md), [operator-proof ADR](adr/0005-operator-proof.md), [audit](AUDIT.md), [risk rules](roles/risk-classes.md). An ADR is not proof every phase shipped. |
